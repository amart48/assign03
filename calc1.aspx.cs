...
namespace assign03
{
    public partial class calc1 : System.Web.UI.Page
    {
        ...
        {
            display.Text = Btn0.Text.ToString();  //take the text off the button and display it in the textbox
            StoreDisplay(Btn0.Text.ToString()); //pass the text off the button into StoreDisplay
        }
